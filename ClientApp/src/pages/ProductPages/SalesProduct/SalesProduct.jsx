    ...
    const fetchProductDetails = async () => {
      try {
        const response = await axios.get(
          `https://bilcampusconnect.azurewebsites.net/api/SalesItem/${productId}`
        );
    ...
    <div className="sales-product-container">
      ...
      <div className="product-details">
        <div className="product-details-left">
          ...
          <div className="info-container">
            <div className="label-text">{priceMes}</div>
            <div className="product-info">{productData.price} TL</div>
          </div>
          <div className="info-container">
          ...
          <div className="info-container">
            ...
            <div className="product-info">{ownerData?.name || 'Loading owner...'}</div>
          </div>
          <div className="info-container">
            <div className="label-text">{tagMes}</div>
            <div className="product-info">{productData.header}</div>
          </div>
        </div>
